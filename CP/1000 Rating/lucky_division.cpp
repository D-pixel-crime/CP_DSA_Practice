...
void getLuckyNums(vector<int> &luckyNums)
{
    luckyNums.push_back(4);
    luckyNums.push_back(7);
    luckyNums.push_back(44);
    luckyNums.push_back(47);
    luckyNums.push_back(77);
    luckyNums.push_back(444);
    luckyNums.push_back(447);
    luckyNums.push_back(474);
    luckyNums.push_back(477);
    luckyNums.push_back(777);
}
